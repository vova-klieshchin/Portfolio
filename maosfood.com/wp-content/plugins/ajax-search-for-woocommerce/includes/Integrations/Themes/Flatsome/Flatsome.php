...
class Flatsome
{
    ...
    public function registerSettings($settings)
    {
        ...
        $settings[$key][10] = array(
            ...
            'label' => __('Replace Flatsome search box', 'ajax-search-for-woocommerce'),
            'type'  => 'head',
        ...
        $settings[$key][55] = array(
            ...
            'desc'    => __('Replaces all Flatsome search boxes to the Ajax Search for WooCommerce.', 'ajax-search-for-woocommerce'),
            'type'    => 'checkbox',
            'default' => 'off',
        );
