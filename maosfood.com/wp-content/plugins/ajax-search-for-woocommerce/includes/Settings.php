    ...
    public function settings_sections()
    {
        ...
        $sections = array(
            ...
            10 => array(
                ...
                'title' => __('Search box', 'ajax-search-for-woocommerce')
            ),
            15 => array(
        ...
        $settingsFields = array(
            'dgwt_wcas_basic'        => apply_filters('dgwt/wcas/settings/section=basic', array(
                10 => array(
                    ...
                    'label' => __('How to add search box in your theme?', 'ajax-search-for-woocommerce'),
                    'type'  => 'head',
                    'class' => 'dgwt-wcas-sgs-header'
                ),
                100 => array(
                    'name'  => 'how_to_use',
                    'label' => __('Add search box', 'ajax-search-for-woocommerce'),
                    'type'  => 'desc',
            ...
            'dgwt_wcas_autocomplete' => apply_filters('dgwt/wcas/settings/section=autocomplete', array(
                ...
                70   => array(
                    ...
                    'label'   => __('Group resutls', 'ajax-search-for-woocommerce'),
                    'type'    => 'checkbox',
                    'size'    => 'small',
                    'default' => 'off',
                ),
