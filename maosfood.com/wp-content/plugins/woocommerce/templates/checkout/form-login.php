...
woocommerce_login_form(
	array(
		'message'  => esc_html__( 'Якщо раніше Ви були зареєстровані на сайті, будь ласка введіть реєстраційні дані нижче. Якщо Ви новий користувач, перейдіть до розділу "Платіжні дані"', 'woocommerce' ),
